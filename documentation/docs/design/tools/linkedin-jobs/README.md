...
- Source: `src/MicroXAgentLoop/Tools/LinkedIn/LinkedInJobsTool.cs`
- Uses `HttpClient` for async HTTP requests
- Parses response HTML with `HtmlAgilityPack`
- Uses a browser-like User-Agent header

## Example

```
you> Find remote .NET developer jobs posted in the last week
```
