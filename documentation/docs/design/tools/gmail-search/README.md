...
On first use, a browser window opens for Google OAuth sign-in. Tokens are cached in `.gmail-tokens/` for future sessions. See [Getting Started](../../../operations/getting-started.md) for setup instructions.
